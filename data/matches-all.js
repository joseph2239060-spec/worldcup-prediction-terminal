...
// 世界杯赛前预测 - 数据源（真实数据版）
// ════════════════════════════════════════════════════════════════
// 数据核实日期：2026-06-08  ·  来源详见 SOURCES.md
// 2026-06-11 揭幕日当天真实只有 2 场比赛，均为 A 组（全部在墨西哥踢）
//   1. 墨西哥 vs 南非   — 揭幕战，Estadio Azteca，墨西哥城
//   2. 韩国   vs 捷克   — Estadio Akron，瓜达拉哈拉
// 概率来自 simulate.py 泊松模型（λ 基于核实的近期战绩+排名+主客场+海拔）
// 球员状态/伤病/排名/场馆均来自 FIFA/ESPN/Sky/Goal（见 SOURCES.md）
// 赔率：尚未接入实时 API，odds 字段暂为占位，录视频前需用 The Odds API 替换
// ════════════════════════════════════════════════════════════════

// 多天注册：每个数据文件把自己注册进 WCP_DAYS，index.html 提供日期切换
window.WCP_DAYS = window.WCP_DAYS || {};
window.WCP_DAYS["2026-06-11"] = {
  "date": "2026-06-11",
  "tournament": "FIFA World Cup 2026 · Group A · Opening Day",
  "model_version": "POISSON v1.0 (baseline)",
  "model_accuracy_7d": null,
  "data_note": "概率=泊松模型估算；球员/排名/场馆=官方核实；赔率=占位待接入",
  "matches": [
    {
      "id": "WC2026_M001",
      ...
      "away": { "code": "RSA", "name_zh": "南非", "flag": "🇿🇦", "fifa_rank": 60 },
      ...
      "probabilities": { "home_win": 68.0, "draw": 19.9, "away_win": 12.0 },
      "expected_goals": { "home": 2.0, "away": 0.7 },
      "expected_score": "2 : 1",
      "over_2_5": 50.9,
      "btts": 41,
      "clean_sheet_home": 50,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 1.30,
          "items": [
            { "label": "altitude_2200m", "value": "高原", "note": "墨西哥城2200m高原，墨完全适应（注:南非主场约堡1750m属部分适应，非纯海平面队）" },
            { "label": "form_8_unbeaten", "value": "状态", "note": "2026年8场友谊赛不败：5-1塞尔维亚/2-0加纳/1-0澳大利亚" },
            { "label": "home_opener_Azteca", "value": "主场", "note": "阿兹台克承办史上第3次揭幕战，87500主场" },
            { "label": "FIFA_rank_14_vs_60", "value": "+46位", "note": "排名差46位" }
          ]
        },
        "home_risk": {
          "score": -0.50,
          "items": [
            { "label": "friendly_quality", "value": "存疑", "note": "8场不败多为友谊赛，对手质量参差" },
            { "label": "GK_uncertainty", "value": "门将", "note": "Ochoa(40岁)还是Rangel先发未定，ESPN预测Rangel" },
            { "label": "opener_pressure", "value": "压力", "note": "东道主揭幕战心理压力大" },
            { "label": "Williams_factor", "value": "对方门神", "note": "南非门将Williams 2023非洲杯点球封神" }
          ]
        },
        "away_upset_path": {
          "score": 0.55,
          "items": [
            { "label": "Foster_threat", "value": "+", "note": "伯恩利前锋Foster 国家队26场10球，英超身体" },
            { "label": "Williams_GK", "value": "+", "note": "门将状态是南非保平的最大底牌" },
            { "label": "Broos_discipline", "value": "+", "note": "Broos纪律性防守体系，擅长1球小胜/逼平" },
            { "label": "opener_low_scoring", "value": "+", "note": "世界杯揭幕战历史普遍低进球" }
          ]
        },
        "live_variables": {
          "score": 0.40,
          "items": [
            { "label": "altitude_diff", "value": "-", "note": "墨2200m vs 南非主场约堡1750m，墨有海拔差优势但非碾压" },
            { "label": "RSA_injuries", "value": "-", "note": "边锋Morena、Nkota伤缺，左后卫Modiba体能存疑(ESPN)" },
            { "label": "RSA_poor_form", "value": "-", "note": "近2场0-0尼加拉瓜、1-1牙买加，Broos公开不满" },
            { "label": "crowd_87500", "value": "+", "note": "阿兹台克满场主场声浪" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Guillermo Ochoa / Rangel", "pos": "GK", "status": "QUEST", "note": "门将先发存争议，ESPN预测Rangel，Ochoa第6届世界杯" },
          { "name": "Edson Álvarez", "pos": "CM", "status": "KEY", "note": "队长，战术核心" },
          { "name": "Raúl Jiménez", "pos": "FW", "status": "KEY", "note": "富勒姆赛季双位数进球，主场世界杯" },
          { "name": "Santiago Giménez", "pos": "FW", "status": "HOT", "note": "AC米兰，禁区嗅觉敏锐" }
        ],
        "away": [
          { "name": "Ronwen Williams", "pos": "GK", "status": "KEY", "note": "队长62场，2023非洲杯点球大战封神" },
          { "name": "Lyle Foster", "pos": "FW", "status": "KEY", "note": "伯恩利，国家队26场10球" },
          { "name": "Teboho Mokoena", "pos": "CM", "status": "OK", "note": "Sundowns中场发动机" },
          { "name": "Aubrey Modiba", "pos": "LB", "status": "QUEST", "note": "伤病恢复中，体能存疑" }
        ]
      },
      "odds": [
      ...
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: FIFA.com official" },
        { "time": "—", "level": "OK", "msg": "FIFA rank MEX#14 RSA#60 (Sofascore)" },
        { "time": "—", "level": "INFO", "msg": "altitude 2200m applied to RSA fatigue weight" },
        { "time": "—", "level": "WARN", "msg": "RSA injuries: Morena/Nkota OUT, Modiba doubt (ESPN)" },
        { "time": "—", "level": "OK", "msg": "poisson output: 68.0 / 19.9 / 12.0" }
      ],
      "result": {
        "status": "FT",
        "home_goals": 2,
        ...
        "scoreline": "2 - 0",
        "scorers": [
          { "min": "9'", "team": "MEX", "player": "Julián Quiñones", "type": "open play" },
          { "min": "67'", "team": "MEX", "player": "Raúl Jiménez", "type": "header (Alvarado cross)" }
        ],
        "red_cards": [
          { "min": "49'", "team": "RSA", "player": "Sithole", "reason": "犯规 Gutiérrez" },
          { "min": "52'", "team": "RSA", "player": "Zwane", "reason": "手击 Alvarado 面部" },
          { "min": "85'", "team": "MEX", "player": "César Montes", "reason": "故意髋部撞人" }
        ],
        "stats": { "shots_home": 16, "shots_on_target_home": 4, "poss_home": 55, "poss_away": 45 },
    ...
    },
    {
      ...
      "round": 1,
      "tag": "CLOSE_MATCH",
      "home": { "code": "KOR", "name_zh": "韩国", "flag": "🇰🇷", "fifa_rank": 25 },
      "away": { "code": "CZE", "name_zh": "捷克", "flag": "🇨🇿", "fifa_rank": 39 },
      ...
      "probabilities": { "home_win": 41.6, "draw": 26.7, "away_win": 31.7 },
      "expected_goals": { "home": 1.35, "away": 1.15 },
      "expected_score": "1 : 1",
      "over_2_5": 45.6,
      "btts": 52,
      "clean_sheet_home": 32,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 0.70,
          "items": [
            { "label": "Son_Heungmin", "value": "+", "note": "队长Son(现LAFC)，可能最后一届世界杯" },
            { "label": "Lee_Kangin", "value": "+", "note": "创造力核心，右路威胁" },
            { "label": "FIFA_rank_25_vs_39", "value": "+14位", "note": "排名占优14位" },
            { "label": "team_speed", "value": "+", "note": "韩国整体速度+逼抢" }
          ]
        },
        "home_risk": {
          "score": -0.55,
          "items": [
            { "label": "vs_Schick_aerial", "value": "-", "note": "韩国后防对Schick 191cm制空力存疑" },
            { "label": "Hwang_fitness", "value": "-", "note": "Hwang Hee-chan刚从脚踝伤恢复" },
            { "label": "neutral_venue", "value": "-", "note": "瓜达拉哈拉中立场地，无主场加成" },
            { "label": "finishing", "value": "-", "note": "缺稳定中锋，Cho Gue-sung把握机会能力波动" }
          ]
        },
        "away_upset_path": {
          "score": 0.85,
          "items": [
            { "label": "Schick_form", "value": "+", "note": "勒沃库森Schick德甲28场16球、国家队52场25球，单点爆破强" },
            { "label": "KOR_defense_collapse", "value": "+", "note": "韩国近期曾被巴西灌5球、科特迪瓦4球，防线遇强攻有崩盘先例" },
            { "label": "Soucek_setpiece", "value": "+", "note": "西汉姆Souček+狼队Krejčí 定位球高点威胁" },
            { "label": "physicality", "value": "+", "note": "捷克身体对抗强于韩国" }
          ]
        },
        "live_variables": {
          "score": 0.00,
          "items": [
            { "label": "altitude_1566m", "value": "±", "note": "瓜达拉哈拉海拔1566m，对双方中性" },
            { "label": "both_travel", "value": "±", "note": "两队都需跨洲飞行，疲劳相当" },
            { "label": "evening_kickoff", "value": "+", "note": "22:00ET夜场，温度较低利于技术发挥" },
            { "label": "humid_55", "value": "±", "note": "湿度55%中性" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Son Heung-min", "pos": "LW", "status": "KEY", "note": "队长，现效力MLS LAFC，可能最后一届世界杯" },
          { "name": "Lee Kang-in", "pos": "RW", "status": "KEY", "note": "巴黎圣日耳曼(PSG)，创造力核心" },
          { "name": "Kim Min-jae", "pos": "CB", "status": "KEY", "note": "拜仁慕尼黑，限制Schick制空的关键后卫" },
          { "name": "Hwang Hee-chan", "pos": "FW", "status": "QUEST", "note": "刚从赛季末脚踝伤恢复" }
        ],
        "away": [
          { "name": "Patrik Schick", "pos": "ST", "status": "HOT", "note": "勒沃库森191cm支点，到队状态极佳" },
          { "name": "Tomáš Souček", "pos": "CM", "status": "KEY", "note": "西汉姆，英超经验+定位球" },
          { "name": "Ladislav Krejčí", "pos": "DF", "status": "OK", "note": "狼队后卫" },
          { "name": "Slavia Prague 班底", "pos": "—", "status": "OK", "note": "26人中10人来自卫冕捷克冠军" }
        ]
      },
      "odds": [
        { "book": "占位-待接入API", "home": null, "draw": null, "away": null, "edge_pct": null }
      ...
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: Sky Sports / Goal" },
        { "time": "—", "level": "OK", "msg": "FIFA rank KOR#25 CZE#39 (Sofascore)" },
        { "time": "—", "level": "INFO", "msg": "neutral venue Guadalajara, no home boost" },
        { "time": "—", "level": "WARN", "msg": "close match: away_win 31.7%, draw 26.7%" },
        { "time": "—", "level": "OK", "msg": "poisson output: 41.6 / 26.7 / 31.7" }
      ],
      "result": {
        "status": "FT",
        "home_goals": 2,
        ...
        "scoreline": "2 - 1",
        "scorers": [
          { "min": "59'", "team": "CZE", "player": "Ladislav Krejčí", "type": "header (队长头球)" },
          { "min": "67'", "team": "KOR", "player": "Hwang In-beom", "type": "扳平" },
          { "min": "80'", "team": "KOR", "player": "Oh Hyeon-gyu", "type": "Hwang助攻绝杀" }
        ],
        "red_cards": [],
...
// 向后兼容：默认仍暴露 6/11（index.html 会用 WCP_DAYS 覆盖）
...
// ══════════════════ matches-0617.js ══════════════════
// 世界杯预测数据 - 2026-06-17（已按官方赛程校正日期归属）
// ⚠️ 部分早期场 ET 开球时间官方未公布、未逐一核实，仅日期已对官方校正；录制不念具体开球时间
window.WCP_DAYS = window.WCP_DAYS || {};
window.WCP_DAYS["2026-06-17"] = {
  ...
  "model_version": "POISSON v1.3 + 反平局低估 + 反灌水",
  "model_accuracy_7d": null,
  "data_note": "概率=泊松+平局修正；★ODDS tab 为真实盘口对比；★加纳vs巴拿马模型反常识看好巴拿马",
  "matches": [
    {
      "id": "WC2026_M021",
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 57.5 / 24.4 / 18.0"
        }
      ],
      "result": {
        "status": "FT",
    ...
    },
    {
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 45.2 / 25.7 / 29.1"
        }
      ],
      "result": {
        "status": "FT",
    ...
    },
    {
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 31.0 / 28.4 / 40.6"
        }
      ],
      "result": {
        "status": "FT",
...
// ══════════════════ matches-0618.js ══════════════════
// 世界杯赛前预测 - 2026-06-18 数据（A/B 组次轮 MD2）
// ════════════════════════════════════════════════════════════════
// ★模型 v1.4：对手强度门槛反灌水 + 不无脑看衰favorite + 平局当风险
//   （吸取6/16-17教训：模型连续在favorite上输给庄家，本批不再系统性看衰强队）
// 队代码对齐盘口 feed：CZE/RSA SUI/BIH CAN/QAT MEX/KOR
// ════════════════════════════════════════════════════════════════
...
window.WCP_DAYS["2026-06-18"] = {
  ...
  "model_version": "POISSON v1.4 · 对手门槛+不看衰强队+平局风险",
  "model_accuracy_7d": null,
  "data_note": "★v1.4修正:favorite给到接近市场、不再无脑下修;平局当风险标;ODDS tab 真实盘口对比",
  "matches": [
    {
      "id": "WC2026_M024",
      ...
      "probabilities": { "home_win": 59.9, "draw": 23.3, "away_win": 16.8 },
      "expected_goals": { "home": 1.75, "away": 0.80 },
      "expected_score": "2 : 1",
      "over_2_5": 46.7,
      "btts": 45.4,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 1.10,
          "items": [
            { "label": "RSA_mid_banned", "value": "具体理由", "note": "南非Zwane禁赛3场+Sithole停赛,创造引擎+中场屏障双缺(非泛泛看衰)" },
            { "label": "Schick_Soucek", "value": "+", "note": "Schick(勒沃库森,首位欧洲顶级联赛百球捷克人)+Souček高点" },
            { "label": "must_win_space", "value": "+", "note": "双方0分,南非必压出,给Schick反击空间" },
            { "label": "Krejci_form", "value": "+", "note": "队长Krejčí MD1进球状态好" }
          ]
        },
        "home_risk": {
          "score": -0.70,
          "items": [
            { "label": "CZE_def_avg", "value": "-", "note": "捷克防守平庸(~1.4失),MD1还0-1负韩国,非铁闸" },
            { "label": "Schick_dependency", "value": "-", "note": "过度依赖Schick,MD1只进1球,一个set-piece就能被逼平" },
            { "label": "Williams_GK", "value": "-", "note": "南非门神Williams能把比赛拖成低比分" }
          ]
        },
        "away_upset_path": {
          "score": 0.55,
          "items": [
            { "label": "park_bus_Williams", "value": "+", "note": "摆大巴靠Williams扑救,守成0-0偷分" },
            { "label": "Mokoena_anchor", "value": "+", "note": "Mokoena(50+场)重组中场,这次别再吃红牌" },
            { "label": "CZE_early_concede", "value": "+", "note": "捷克平庸防线早丢球,南非守住" }
          ]
        },
        "live_variables": {
          "score": 0.00,
          "items": [
            { "label": "RSA_XI", "value": "±", "note": "谁填Zwane/Sithole的中场空缺=南非λ大变量" },
            { "label": "early_goal", "value": "±", "note": "捷克早进球则掏空的南非崩;南非早进则摆大巴" },
            { "label": "RSA_discipline", "value": "-", "note": "南非MD1已被罚下2人,再吃红则崩盘(主裁Penso尺度)" },
            { "label": "Schick_fit", "value": "±", "note": "Schick状态+捷克是否轮换(负韩国后)" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Patrik Schick", "pos": "ST", "status": "HOT", "note": "勒沃库森,头号杀器" },
          { "name": "Tomáš Souček", "pos": "CM", "status": "KEY", "note": "西汉姆,高点+后插上" },
          { "name": "Ladislav Krejčí", "pos": "DF", "status": "OK", "note": "队长,MD1进球" },
          { "name": "捷克后防", "pos": "DF", "status": "QUEST", "note": "~1.4失球,负韩国,非铁闸" }
        ],
        "away": [
          { "name": "Ronwen Williams", "pos": "GK", "status": "KEY", "note": "门神,搅局唯一指望" },
          { "name": "Teboho Mokoena", "pos": "CM", "status": "OK", "note": "50+场,重组中场" },
          { "name": "Themba Zwane", "pos": "AM", "status": "SUSP", "note": "★禁赛3场,创造引擎缺阵" },
          { "name": "Sphephelo Sithole", "pos": "CM", "status": "SUSP", "note": "停赛1场,中场屏障缺" }
        ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: FIFA / ESPN, Group A MD2" },
        { "time": "—", "level": "OK", "msg": "FIFA rank CZE#40 RSA#60" },
        { "time": "—", "level": "INFO", "msg": "v1.4: 具体理由(南非中场停赛)推高捷克λ,非无脑看衰" },
        { "time": "—", "level": "OK", "msg": "poisson output: 59.9 / 23.3 / 16.8" }
      ],
      "result": {
        "status": "FT", "home_goals": 1, "away_goals": 1, "scoreline": "1 - 1",
        "scorers": [ { "min": "—", "team": "CZE", "player": "捷克", "type": "" }, { "min": "—", "team": "RSA", "player": "南非", "type": "残阵逼平" } ],
        "red_cards": [],
        "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
    ...
    },
    {
      ...
      "probabilities": { "home_win": 44.5, "draw": 28.5, "away_win": 27.0 },
      "expected_goals": { "home": 1.55, "away": 1.15 },
      "expected_score": "1 : 1",
      "over_2_5": 47.0,
      "btts": 52.0,
      "clean_sheet_home": 30.0,
      "confidence": 58,
      "monte_carlo_n": 50000,
      "value_rating": 3,
      "edge_pct": null,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 0.65,
          "items": [
            { "label": "rank_19_vs_63", "value": "+", "note": "Akanji/Xhaka/Embolo/Kobel全线更深更强" },
            { "label": "Embolo_hot", "value": "+", "note": "Embolo MD1点球后火热;瑞士对卡塔尔26脚射门,进球该正回归" },
            { "label": "no_discount", "value": "+", "note": "波黑FIFA63非鱼腩,瑞士λ不折扣,给到贴近市场的1.55" },
            { "label": "BIH_blunt", "value": "+", "note": "波黑进攻乏力(近6场五次1-1),Džeko只是伤疑替补" }
          ]
        },
        "home_risk": {
          "score": -0.85,
          "items": [
            { "label": "SUI_wasteful", "value": "-", "note": "MD1被卡塔尔1-1逼平,94分钟丢乌龙,终结+管理不稳" },
            { "label": "BIH_unbeaten9", "value": "-", "note": "波黑9场不败(W3D6L1),专磨1-1,组织性强" },
            { "label": "Lukic_form", "value": "-", "note": "Lukić MD1头球,波黑附加赛淘汰意大利/威尔士,不怵强队" },
            { "label": "neutral", "value": "-", "note": "中立场无主场加成,平地对决" }
          ]
        },
        "away_upset_path": {
          "score": 0.85,
          "items": [
            { "label": "low_block_1-1", "value": "+", "note": "波黑低位铁桶,复刻1-1专长至少抢分" },
            { "label": "Demirovic_setpiece", "value": "+", "note": "Lukić/Demirović定位球/反击,瑞士又浪费机会" },
            { "label": "Dzeko_super_sub", "value": "+", "note": "Džeko替补登场抢绝杀打瑞士疲惫腿" }
          ]
        },
        "live_variables": {
          "score": 0.00,
          "items": [
            { "label": "Dzeko_start", "value": "±", "note": "Džeko(肩伤QUEST)首发还是替补=波黑进攻上限" },
            { "label": "first_goal", "value": "±", "note": "瑞士先进则波黑放弃铁桶;波黑先进则平/冷飙升" },
            { "label": "SUI_finishing", "value": "±", "note": "瑞士能否把大量射门转化(MD1的痛点)" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Manuel Akanji", "pos": "CB", "status": "KEY", "note": "曼城,后防核心" },
          { "name": "Granit Xhaka", "pos": "CM", "status": "KEY", "note": "中场组织" },
          { "name": "Breel Embolo", "pos": "ST", "status": "HOT", "note": "MD1点球,状态火热" },
          { "name": "Gregor Kobel", "pos": "GK", "status": "OK", "note": "门将" }
        ],
        "away": [
          { "name": "Jovo Lukić", "pos": "FW", "status": "KEY", "note": "MD1头球破门" },
          { "name": "Ermedin Demirović", "pos": "FW", "status": "OK", "note": "锋线" },
          { "name": "Edin Džeko", "pos": "ST", "status": "QUEST", "note": "肩伤,可能替补登场" },
          { "name": "Sead Kolašinac", "pos": "DF", "status": "OK", "note": "经验+对抗" }
        ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: FIFA / ESPN, Group B MD2" },
        { "time": "—", "level": "OK", "msg": "FIFA rank SUI#19 BIH#63" },
        { "time": "—", "level": "WARN", "msg": "λ差小(0.4)+波黑专磨平 → 平局风险28.5%(高)" },
        { "time": "—", "level": "OK", "msg": "poisson output: 44.5 / 28.5 / 27.0" }
      ],
      "result": {
        "status": "FT", "home_goals": 4, "away_goals": 1, "scoreline": "4 - 1",
        "scorers": [ { "min": "—", "team": "SUI", "player": "瑞士(4球)", "type": "Embolo领衔大爆发" }, { "min": "—", "team": "BIH", "player": "波黑", "type": "扳回一球" } ],
        "red_cards": [],
        "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
    ...
    },
    {
      ...
      "probabilities": { "home_win": 56.4, "draw": 25.5, "away_win": 18.0 },
      "expected_goals": { "home": 1.55, "away": 0.75 },
      "expected_score": "1 : 0",
      "over_2_5": 40.4,
      "btts": 41.6,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 0.90,
          "items": [
            { "label": "rank_30_vs_56", "value": "+", "note": "排名+实力占优,BC Place主场气氛" },
            { "label": "CAN_def", "value": "+", "note": "加拿大近10场场均失0.4,防守稳,卡塔尔进攻仅0.7" },
            { "label": "QAT_leaky", "value": "+", "note": "卡塔尔近期0-3瑞士/1-4某场,失球高,零封率47%" },
            { "label": "must_win", "value": "+", "note": "加拿大MD1平,本场必须取胜出线压力转化主动" }
          ]
        },
        "home_risk": {
          "score": -0.65,
          "items": [
            { "label": "CAN_blunt", "value": "-", "note": "加拿大近10场场均仅1球,Jonathan David把握差,1-0易被末段逼平(像MD1 90+丢平)" },
            { "label": "QAT_counter", "value": "-", "note": "卡塔尔深防铁桶+末段偷袭,平局25.5%不可忽视" },
            { "label": "Davies", "value": "-", "note": "Davies若仍缺/受限,左路威胁打折" }
          ]
        },
        "away_upset_path": {
          "score": 0.55,
          "items": [
            { "label": "Afif_Almoez", "value": "+", "note": "Afif/Almoez Ali反击+定位球(Khoukhi高点,MD1逼平瑞士)偷分" },
            { "label": "park_bus", "value": "+", "note": "卡塔尔摆大巴磨加拿大钝刀进攻" },
            { "label": "CAN_wasteful", "value": "+", "note": "加拿大浪费机会则平局通道开" }
          ]
        },
        "live_variables": {
          "score": 0.00,
          "items": [
            { "label": "Davies_start", "value": "±", "note": "Davies是否首发+健康,影响加拿大λ ±0.2" },
            { "label": "QAT_GK", "value": "±", "note": "卡塔尔门将选择(Abunada vs Barsham)影响失球预期" },
            { "label": "first_goal", "value": "±", "note": "加拿大早进球则卡塔尔被迫压出,大球升" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Alphonso Davies", "pos": "LB/LW", "status": "QUEST", "note": "拜仁,左路威胁,健康存疑" },
          { "name": "Jonathan David", "pos": "ST", "status": "OK", "note": "终结点,把握机会是变量" },
          { "name": "Tajon Buchanan", "pos": "WG", "status": "OK", "note": "边路" },
          { "name": "Stephen Eustáquio", "pos": "CM", "status": "OK", "note": "中场组织" }
        ],
        "away": [
          { "name": "Akram Afif", "pos": "AM", "status": "KEY", "note": "反击组织核心" },
          { "name": "Almoez Ali", "pos": "ST", "status": "OK", "note": "终结点" },
          { "name": "Boualem Khoukhi", "pos": "DF", "status": "OK", "note": "定位球高点(MD1逼平瑞士进球)" },
          { "name": "卡塔尔门将", "pos": "GK", "status": "OK", "note": "Abunada/Barsham" }
        ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: FIFA / ESPN, Group B MD2" },
        { "time": "—", "level": "OK", "msg": "FIFA rank CAN#30 QAT#56" },
        { "time": "—", "level": "INFO", "msg": "v1.4: 加拿大给到56.4%(贴市场),平局风险中(25.5%)" },
        { "time": "—", "level": "OK", "msg": "poisson output: 56.4 / 25.5 / 18.0" }
      ],
      "result": {
        "status": "FT", "home_goals": 6, "away_goals": 0, "scoreline": "6 - 0",
        "scorers": [ { "min": "—", "team": "CAN", "player": "加拿大(6球)", "type": "血洗" } ],
        "red_cards": [],
        "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
    ...
    },
    {
      ...
      "probabilities": { "home_win": 53.7, "draw": 23.6, "away_win": 22.7 },
      "expected_goals": { "home": 1.75, "away": 1.05 },
      "expected_score": "2 : 1",
      "over_2_5": 57.5,
      "btts": 57.6,
      ...
      "modules": {
        "home_win_reasons": {
          "score": 1.00,
          "items": [
            { "label": "form_rank", "value": "+", "note": "墨西哥FIFA14 vs 韩25,近10场8胜2平不败,市场favorite(模型贴线53.7%不下压)" },
            { "label": "home_altitude", "value": "+", "note": "Akron海拔1566m+完全适应主场,韩国客场+海拔劣势" },
            { "label": "hot_attack", "value": "+", "note": "Jiménez+Quiñones MD1都进球;韩国后防~1.2失(被科特迪瓦灌4)" },
            { "label": "no_minnow_discount", "value": "+", "note": "墨西哥1.9进球含5-1塞尔维亚等强队战绩,不折扣" }
          ]
        },
        "home_risk": {
          "score": -0.95,
          "items": [
            { "label": "Montes_susp", "value": "-", "note": "★Montes停赛,中卫重组,0.2失球的铁防难保(这是调高韩国λ的主因)" },
            { "label": "Son_quality", "value": "-", "note": "Son+Hwang In-beom(MD1进球)+Lee Kang-in top30级反击,零封仅32%" },
            { "label": "BTTS_high", "value": "-", "note": "双方都进概率57.6%,墨西哥难零封" }
          ]
        },
        "away_upset_path": {
          "score": 0.80,
          "items": [
            { "label": "transition_Son", "value": "+", "note": "韩国深守反击,Son/Lee Kang-in速度打Montes缺阵的重组后防" },
            { "label": "Hwang_tempo", "value": "+", "note": "Hwang In-beom控中场(像对捷克)+韩国先进球迫墨西哥压上" },
            { "label": "altitude_overcome", "value": "+", "note": "若韩国扛住开场海拔冲击,下半场反扑" }
          ]
        },
        "live_variables": {
          "score": 0.00,
          "items": [
            { "label": "Montes_replace", "value": "±", "note": "谁替Montes搭档Edson Álvarez=墨西哥后防变量" },
            { "label": "KOR_fit", "value": "±", "note": "Kim Min-jae(膝)+Lee Kang-in伤情是否首发" },
            { "label": "rain", "value": "-", "note": "若降雨加大,下调大球与墨西哥控制" },
            { "label": "first_goal", "value": "±", "note": "韩国先进则墨西哥压上露反击空间" }
          ]
        }
      },
      "players": {
        "home": [
          { "name": "Raúl Jiménez", "pos": "FW", "status": "HOT", "note": "MD1进球" },
          { "name": "Julián Quiñones", "pos": "FW", "status": "HOT", "note": "MD1进球" },
          { "name": "Edson Álvarez", "pos": "CM", "status": "KEY", "note": "队长" },
          { "name": "César Montes", "pos": "CB", "status": "SUSP", "note": "★停赛,后防被迫重组" }
        ],
        "away": [
          { "name": "Son Heung-min", "pos": "LW", "status": "KEY", "note": "队长,反击爆点" },
          { "name": "Hwang In-beom", "pos": "CM", "status": "KEY", "note": "MD1进球,控中场" },
          { "name": "Lee Kang-in", "pos": "RW", "status": "QUEST", "note": "PSG,伤情存疑" },
          { "name": "Kim Min-jae", "pos": "CB", "status": "QUEST", "note": "拜仁,膝伤存疑" }
        ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "fixture verified: FIFA / ESPN, Group A MD2" },
        { "time": "—", "level": "OK", "msg": "FIFA rank MEX#14 KOR#25" },
        { "time": "—", "level": "WARN", "msg": "Montes停赛→调高韩国λ(而非下压墨西哥),v1.4手法" },
        { "time": "—", "level": "OK", "msg": "poisson output: 53.7 / 23.6 / 22.7" }
      ],
      "result": {
        "status": "FT", "home_goals": 1, "away_goals": 0, "scoreline": "1 - 0",
        "scorers": [ { "min": "—", "team": "MEX", "player": "墨西哥", "type": "1-0小胜,率先出线" } ],
        "red_cards": [],
        "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
...
// ══════════════════ matches-0619.js ══════════════════
// 世界杯赛前预测 - 2026-06-19 数据（MD2）
// ════════════════════════════════════════════════════════════════
// ⚠️ 事后回填:6/19 发哥不在,无真实赛前预测记录。本日预测由 Workflow 用
//    【赛前因素】(排名/状态/伤停)生成、指令明确要求忽略已知比分——但 agents
//    上网可能瞥见结果,故不作为"真实盲测战绩",仅补全工具记录。复盘照常。
// 队代码对齐盘口 feed：SCO/MAR BRA/HAI USA/AUS TUR/PAR
// ════════════════════════════════════════════════════════════════
...
window.WCP_DAYS["2026-06-19"] = {
  ...
  "model_accuracy_7d": null,
  "data_note": "⚠️事后回填:无真实赛前记录,不计入盲测战绩;预测用赛前因素生成",
  "matches": [
    {
      "id": "WC2026_M028",
      ...
      "round": 2,
      "tag": null,
      "home": { "code": "SCO", "name_zh": "苏格兰", "flag": "🏴", "fifa_rank": 37 },
      "away": { "code": "MAR", "name_zh": "摩洛哥", "flag": "🇲🇦", "fifa_rank": 7 },
      "venue": "Gillette Stadium, 福克斯堡",
      "altitude_m": 28, "temp_c": 26, "humidity_pct": 60,
      "referee": "Tantashev",
      "headline": "摩洛哥55.6%（客场favorite）：非洲杯卫冕冠军+苏格兰后防伤兵告急。模型站摩洛哥",
      "probabilities": { "home_win": 21.3, "draw": 23.1, "away_win": 55.6 },
      "expected_goals": { "home": 1.02, "away": 1.80 },
      "expected_score": "1 : 2", "over_2_5": 53.3, "btts": 53.2, "clean_sheet_home": 16.5,
      "confidence": 62, "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 0.40, "items": [
          { "label": "setpiece", "value": "+", "note": "McGinn/McTominay定位球+反击是苏格兰唯一现实路径" },
          { "label": "MD1_clean", "value": "+", "note": "MD1 1-0小胜海地,能死守低比分" },
          { "label": "ref_loose", "value": "±", "note": "主裁首执世界杯,若放任对抗利苏格兰拼抢" } ] },
        "home_risk": { "score": -1.20, "items": [
          { "label": "Hickey_OUT", "value": "-", "note": "右后卫Hickey大概率缺阵+McKenna存疑→Hakimi右路猛攻" },
          { "label": "Gilmour_OUT", "value": "-", "note": "中场核心Gilmour赛季报销,控球出球缺失" },
          { "label": "no_striker", "value": "-", "note": "缺顶级前锋,落后难翻盘,零封自己仅16.5%" } ] },
        "away_upset_path": { "score": 1.45, "items": [
          { "label": "MAR_AFCON", "value": "+", "note": "非洲杯卫冕冠军,近9场7胜2平不败,失球~0.3" },
          { "label": "Hakimi_Diaz", "value": "+", "note": "Hakimi+Brahim Díaz+Saibari火热,打苏格兰残破右路" },
          { "label": "real_def", "value": "+", "note": "摩洛哥防守真材实料(MD1逼平巴西),反灌水后λ仍1.8" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "SCO_backline", "value": "±", "note": "Hickey/McKenna是否双缺,缺则摩洛哥λ再上调" },
          { "label": "first_goal", "value": "±", "note": "苏格兰早进球才有死守爆冷的可能" },
          { "label": "MAR_rotation", "value": "±", "note": "摩洛哥1平需胜,大概率全力出击" } ] }
      },
      "players": {
        "home": [
          { "name": "Scott McTominay", "pos": "CM", "status": "KEY", "note": "进攻中场,定位球" },
          { "name": "John McGinn", "pos": "CM", "status": "OK", "note": "中场推进" },
          { "name": "Billy Gilmour", "pos": "CM", "status": "OUT", "note": "赛季报销,中场控制缺失" },
          { "name": "Aaron Hickey", "pos": "RB", "status": "OUT", "note": "右后卫缺阵,Hakimi猛攻区" } ],
        "away": [
          { "name": "Achraf Hakimi", "pos": "RB", "status": "HOT", "note": "攻防一体,打苏格兰残破右路" },
          { "name": "Brahim Díaz", "pos": "AM", "status": "HOT", "note": "线间杀手" },
          { "name": "Ismael Saibari", "pos": "AM", "status": "OK", "note": "MD1对巴西进球" },
          { "name": "Yassine Bounou", "pos": "GK", "status": "KEY", "note": "门神" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "⚠️ backfill prediction (事后回填,非盲测)" },
        { "time": "—", "level": "OK", "msg": "FIFA rank SCO#37 MAR#7" },
        { "time": "—", "level": "OK", "msg": "poisson output: 21.3 / 23.1 / 55.6" } ],
      "result": {
        "status": "FT", "home_goals": 0, "away_goals": 1, "scoreline": "0 - 1",
        "scorers": [ { "min": "—", "team": "MAR", "player": "摩洛哥", "type": "1-0小胜" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "摩洛哥0-1小胜苏格兰。回填模型选摩洛哥(55.6%)=对", "source": "ESPN"
      },
      "review": {
        "verdict": "HIT",
        "headline": "（回填）方向命中：模型站客场favorite摩洛哥(55.6%)→摩洛哥1-0赢。苏格兰伤兵+摩洛哥质量的判断对",
        "hits": [ "胜负方向对：摩洛哥55.6%最高→赢 ✓", "低比分判断对(0-1)", "苏格兰后防伤兵被Hakimi打的逻辑成立" ],
        "misses": [ "⚠️这是事后回填,不算真实盲测命中" ],
    ...
    },
    {
      ...
      "round": 2,
      "tag": null,
      "home": { "code": "BRA", "name_zh": "巴西", "flag": "🇧🇷", "fifa_rank": 6 },
      "away": { "code": "HAI", "name_zh": "海地", "flag": "🇭🇹", "fifa_rank": 85 },
      "venue": "MetLife Stadium, 新泽西",
      "altitude_m": 7, "temp_c": 28, "humidity_pct": 70,
      "referee": "未公布",
      "headline": "巴西76.4%：全届最大排名差(6 vs 85)。Vinícius火热,海地只能靠门将Placide死守",
      "probabilities": { "home_win": 76.4, "draw": 16.0, "away_win": 7.6 },
      "expected_goals": { "home": 2.30, "away": 0.57 },
      "expected_score": "2 : 0", "over_2_5": 54.3, "btts": 39.0, "clean_sheet_home": 56.6,
      "confidence": 78, "monte_carlo_n": 50000, "value_rating": 2, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 1.80, "items": [
          { "label": "rank_gap_79", "value": "+", "note": "FIFA 6 vs 85,全届最大差;Opta超算给巴西~87%" },
          { "label": "Vini_hot", "value": "+", "note": "Vinícius火热(MD1对摩洛哥扳平),Raphinha两翼" },
          { "label": "midfield", "value": "+", "note": "Casemiro+Bruno Guimarães中场territory碾压" },
          { "label": "must_win", "value": "+", "note": "MD1平摩洛哥后需取胜保组头" } ] },
        "home_risk": { "score": -0.50, "items": [
          { "label": "Neymar_OUT", "value": "-", "note": "Neymar缺阵+可能轮换,慢热风险" },
          { "label": "storm", "value": "-", "note": "84%雷暴,湿滑场地降低终结质量" },
          { "label": "Placide_block", "value": "-", "note": "海地老门将Placide+铁桶,首球延误则1-0紧张" } ] },
        "away_upset_path": { "score": 0.30, "items": [
          { "label": "Placide_MOTM", "value": "+", "note": "Placide神勇守成0-0僵局" },
          { "label": "Isidor_counter", "value": "+", "note": "Isidor(桑德兰)反击是海地唯一现实进球点" },
          { "label": "storm_chaos", "value": "+", "note": "雷暴湿地加方差(但巴西胜率仍76%)" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "BRA_rotation", "value": "±", "note": "巴西轮换程度+Neymar最终状态" },
          { "label": "storm", "value": "-", "note": "雷暴是否落地影响节奏" },
          { "label": "first_goal", "value": "±", "note": "早进球则3-0+,延误则压2-0/1-0" } ] }
      },
      "players": {
        "home": [
          { "name": "Vinícius Júnior", "pos": "LW", "status": "HOT", "note": "MD1扳平,头号点" },
          { "name": "Raphinha", "pos": "RW", "status": "KEY", "note": "右翼" },
          { "name": "Casemiro", "pos": "CDM", "status": "OK", "note": "中场拦截" },
          { "name": "Neymar", "pos": "AM", "status": "OUT", "note": "缺阵" } ],
        "away": [
          { "name": "Johny Placide", "pos": "GK", "status": "KEY", "note": "~84场老门将,死守指望" },
          { "name": "Wilson Isidor", "pos": "ST", "status": "OK", "note": "桑德兰,唯一现实进球点" },
          { "name": "Frantzdy Pierrot", "pos": "ST", "status": "OK", "note": "支点" },
          { "name": "海地后防", "pos": "DF", "status": "QUEST", "note": "深位铁桶,失球~1.4" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "⚠️ backfill prediction (事后回填,非盲测)" },
        { "time": "—", "level": "OK", "msg": "FIFA rank BRA#6 HAI#85; Opta 87%" },
        { "time": "—", "level": "OK", "msg": "poisson output: 76.4 / 16.0 / 7.6" } ],
      "result": {
        "status": "FT", "home_goals": 3, "away_goals": 0, "scoreline": "3 - 0",
        "scorers": [ { "min": "—", "team": "BRA", "player": "巴西(3球)", "type": "Vinícius领衔" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "巴西3-0完胜海地。回填模型选巴西(76.4%)=对,进球λ2.3也接近(实际3)", "source": "ESPN"
      },
      "review": {
        "verdict": "HIT",
        "headline": "（回填）方向命中：巴西76.4%→3-0完胜。进球λ2.3比之前的钝刀准多了(实际3球)",
        "hits": [ "胜负方向对：巴西76.4%→赢 ✓", "★进球λ修正见效：给巴西2.3(实际3),不再像之前压到1球" ],
        "misses": [ "⚠️事后回填,不算盲测" ],
    ...
    },
    {
      ...
      "tag": null,
      "home": { "code": "USA", "name_zh": "美国", "flag": "🇺🇸", "fifa_rank": 17 },
      "away": { "code": "AUS", "name_zh": "澳大利亚", "flag": "🇦🇺", "fifa_rank": 27 },
      "venue": "Lumen Field, 西雅图",
      "altitude_m": 5, "temp_c": 24, "humidity_pct": 55,
      "referee": "Felix Zwayer",
      "headline": "美国56%：主场+MD1 4-1大胜巴拉圭。但Pulisic缺阵+多人黄牌临界，澳洲5-4-1反击能搅",
      "probabilities": { "home_win": 56.0, "draw": 23.5, "away_win": 20.3 },
      "expected_goals": { "home": 1.75, "away": 0.95 },
      "expected_score": "2 : 1", "over_2_5": 50.4, "btts": 50.5, "clean_sheet_home": 38.6,
      "confidence": 64, "monte_carlo_n": 50000, "value_rating": 2, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 0.90, "items": [
          { "label": "home_form", "value": "+", "note": "主场Lumen+MD1 4-1大胜巴拉圭,火力(~2.1)高于澳洲" },
          { "label": "Balogun_hot", "value": "+", "note": "Balogun热状态+Pepi顶替,波切蒂诺体系火力足" },
          { "label": "h2h", "value": "+", "note": "2025-10友谊赛美国2-1胜澳洲,对位占优" },
          { "label": "AUS_low_output", "value": "+", "note": "澳洲5-4-1失球少但进攻产出低,客场更保守" } ] },
        "home_risk": { "score": -0.75, "items": [
          { "label": "Pulisic_OUT", "value": "-", "note": "★普利西奇缺阵,左路创造+定位球点缺失,破密集防守效率降" },
          { "label": "yellow_cards", "value": "-", "note": "Adams/Robinson/Balogun/Richards黄牌停赛边缘,踢得保守" },
          { "label": "Irankunda", "value": "-", "note": "澳洲Irankunda速度反击一击致命(BTTS 50%)" } ] },
        "away_upset_path": { "score": 0.55, "items": [
          { "label": "park_bus_60", "value": "+", "note": "5-4-1顶住前60分钟,靠转换/定位球偷分" },
          { "label": "USA_no_Pulisic", "value": "+", "note": "美国无普利西奇进攻钝化,久攻不下压上失衡" },
          { "label": "counter", "value": "+", "note": "Irankunda/Metcalfe反击或角球抓机会" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "Pulisic_replace", "value": "±", "note": "谁顶普利西奇的创造位" },
          { "label": "yellow_mgmt", "value": "-", "note": "美国为保R32黄牌管理影响逼抢强度" },
          { "label": "first_goal", "value": "±", "note": "美国早进球则澳洲压出,大球升" } ] }
      },
      "players": {
        "home": [
          { "name": "Folarin Balogun", "pos": "ST", "status": "HOT", "note": "MD1梅开二度" },
          { "name": "Ricardo Pepi", "pos": "ST", "status": "OK", "note": "顶替轮换" },
          { "name": "Christian Pulisic", "pos": "LW", "status": "OUT", "note": "★缺阵,创造核心" },
          { "name": "Tyler Adams", "pos": "CM", "status": "QUEST", "note": "黄牌停赛边缘" } ],
        "away": [
          { "name": "Nestory Irankunda", "pos": "WG", "status": "KEY", "note": "速度反击,MD1对土耳其进球" },
          { "name": "Connor Metcalfe", "pos": "CM", "status": "OK", "note": "MD1进球" },
          { "name": "Harry Souttar", "pos": "CB", "status": "OK", "note": "防空" },
          { "name": "Maty Ryan", "pos": "GK", "status": "KEY", "note": "门将" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "⚠️ backfill prediction (事后回填,非盲测)" },
        { "time": "—", "level": "OK", "msg": "FIFA rank USA#17 AUS#27; H2H USA 2-1" },
        { "time": "—", "level": "OK", "msg": "poisson output: 56.0 / 23.5 / 20.3" } ],
      "result": {
        "status": "FT", "home_goals": 2, "away_goals": 0, "scoreline": "2 - 0",
        "scorers": [ { "min": "—", "team": "USA", "player": "美国(2球)", "type": "" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "美国2-0澳洲,无普利西奇照样拿下。回填模型选美国(56%)=对", "source": "ESPN"
      },
      "review": {
        "verdict": "HIT",
        "headline": "（回填）方向命中：美国56%→2-0。缺普利西奇仍赢,且零封(模型给零封38.6%偏低,实际守住)",
        "hits": [ "胜负方向对：美国56%→赢 ✓", "期望比分2:1接近实际2-0", "澳洲反击没兑现,美国防住" ],
        "misses": [ "⚠️事后回填", "略低估美国零封能力" ],
    ...
    },
    {
      ...
      "round": 2,
      "tag": "CLOSE_MATCH",
      "home": { "code": "TUR", "name_zh": "土耳其", "flag": "🇹🇷", "fifa_rank": 22 },
      "away": { "code": "PAR", "name_zh": "巴拉圭", "flag": "🇵🇾", "fifa_rank": 41 },
      "venue": "BC Place, 温哥华",
      "altitude_m": 0, "temp_c": 22, "humidity_pct": 55,
      "referee": "未公布",
      "headline": "今日最焦灼：土耳其39.5/平28/巴拉圭32.5，几乎三选一。模型微弱选土耳其",
      "probabilities": { "home_win": 39.5, "draw": 28.0, "away_win": 32.5 },
      "expected_goals": { "home": 1.35, "away": 1.20 },
      "expected_score": "1 : 1", "over_2_5": 46.9, "btts": 51.7, "clean_sheet_home": 30.1,
      "confidence": 52, "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "ELEVATED",
      "modules": {
        "home_win_reasons": { "score": 0.55, "items": [
          { "label": "Guler", "value": "+", "note": "Güler(皇马)创造力,土耳其纸面更强" },
          { "label": "must_win", "value": "+", "note": "土耳其MD1负澳洲,本场必须取胜" },
          { "label": "rank_22_vs_41", "value": "+", "note": "排名占优,但差距不大" } ] },
        "home_risk": { "score": -0.80, "items": [
          { "label": "PAR_elite_def", "value": "-", "note": "巴拉圭铁桶,Gustavo Gómez领衔,预选失球少" },
          { "label": "TUR_MD1_loss", "value": "-", "note": "土耳其MD1 0-2负澳洲,信心+进攻存疑" },
          { "label": "Almiron_counter", "value": "-", "note": "巴拉圭Almirón反击速度威胁" } ] },
        "away_upset_path": { "score": 0.70, "items": [
          { "label": "deep_block", "value": "+", "note": "巴拉圭低位铁桶+反击,专磨" },
          { "label": "TUR_pressure", "value": "+", "note": "土耳其必胜压力下易急躁失衡" },
          { "label": "Sanabria", "value": "+", "note": "Sanabria反击终结" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "TUR_attack", "value": "±", "note": "土耳其能否打破巴拉圭铁桶=胜负关键" },
          { "label": "first_goal", "value": "±", "note": "巴拉圭先进则关门死守" },
          { "label": "cards", "value": "-", "note": "对抗激烈,红牌风险偏高" } ] }
      },
      "players": {
        "home": [
          { "name": "Arda Güler", "pos": "AM", "status": "KEY", "note": "皇马,创造核心" },
          { "name": "Kerem Aktürkoğlu", "pos": "WG", "status": "OK", "note": "边路" },
          { "name": "Hakan Çalhanoğlu", "pos": "CM", "status": "QUEST", "note": "国米,伤情存疑" },
          { "name": "土耳其锋线", "pos": "FW", "status": "QUEST", "note": "MD1 0-2哑火" } ],
        "away": [
          { "name": "Gustavo Gómez", "pos": "CB", "status": "KEY", "note": "队长,铁桶核心" },
          { "name": "Miguel Almirón", "pos": "RW", "status": "KEY", "note": "反击速度" },
          { "name": "Antonio Sanabria", "pos": "ST", "status": "OK", "note": "反击终结" },
          { "name": "Julio Enciso", "pos": "AM", "status": "OK", "note": "创造力" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "⚠️ backfill prediction (事后回填,非盲测)" },
        { "time": "—", "level": "OK", "msg": "FIFA rank TUR#22 PAR#41" },
        { "time": "—", "level": "WARN", "msg": "三选一接近(39.5/28/32.5),低置信度52%" },
        { "time": "—", "level": "OK", "msg": "poisson output: 39.5 / 28.0 / 32.5" } ],
      "result": {
        "status": "FT", "home_goals": 0, "away_goals": 1, "scoreline": "0 - 1",
        "scorers": [ { "min": "—", "team": "PAR", "player": "巴拉圭", "type": "铁桶+反击1-0" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "巴拉圭0-1小胜土耳其。回填模型微弱选土耳其(39.5%)=错,巴拉圭铁桶赢了", "source": "ESPN"
      },
      "review": {
        "verdict": "MISS",
        "headline": "（回填）方向失手：模型微弱选土耳其(39.5%)，巴拉圭1-0赢。但这本就是模型标的'最接近、低置信52%'比赛",
        "hits": [ "★诚实标了低置信(52%)+三选一接近→没有过度自信", "away_upset_path'巴拉圭铁桶+反击偷分'→正是发生的", "低比分判断对(0-1)" ],
        "misses": [ "方向选了土耳其,实际巴拉圭赢", "⚠️事后回填" ],
...
// ══════════════════ matches-0623.js ══════════════════
// 世界杯预测数据 - 2026-06-23（已按官方赛程校正日期归属）
// ⚠️ 部分早期场 ET 开球时间官方未公布、未逐一核实，仅日期已对官方校正；录制不念具体开球时间
window.WCP_DAYS = window.WCP_DAYS || {};
window.WCP_DAYS["2026-06-23"] = {
  ...
  "model_version": "POISSON v1.4",
  "model_accuracy_7d": null,
  "data_note": "★真预测,ODDS tab有实时盘口;v1.4强队进攻放开(葡/英λ 2.25-2.35)",
  "matches": [
    {
      "id": "WC2026_M044",
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 71.5 / 17.8 / 10.7"
        }
      ],
      "result": {
        "status": "FT",
    ...
    },
    {
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 61.4 / 22.2 / 16.1"
        }
      ],
      "result": {
        "status": "FT",
    ...
    },
    {
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 71.4 / 16.9 / 10.7"
        }
      ],
      "result": {
        "status": "FT",
    ...
    },
    {
      ...
      "live_log": [
        ...
        },
        {
          "time": "—",
          "level": "OK",
          "msg": "poisson output: 16.5 / 22.0 / 61.5"
        }
      ],
      "result": {
        "status": "FT",
...
// ══════════════════ matches-0626.js ══════════════════
// 世界杯预测 - 2026-06-26（小组末轮 MD3 收官·I/H/G组，真预测，带盘口）
// 看点:豪门扎堆——挪威vs法国(都出线争头名)、乌拉圭vs西班牙、新西兰vs比利时
// 教训应用:已出线豪强是双刃——有动机(争头名)或打鱼腩则碾压;真无欲+对手拼命则爆冷(参6/25德国/美国翻车)
// 队代码:NOR/FRA SEN/IRQ URU/ESP CPV/KSA NZL/BEL EGY/IRN
window.WCP_DAYS = window.WCP_DAYS || {};
window.WCP_DAYS["2026-06-26"] = {
  "date": "2026-06-26", "tournament": "FIFA World Cup 2026 · 小组末轮收官 MD3 (I/H/G组)",
  "model_version": "POISSON v1.4 + 末轮轮换修正", "model_accuracy_7d": null,
  "data_note": "★真预测,ODDS tab有盘口;末轮豪强双刃:争头名/打鱼腩则碾压,真无欲+对手拼命则爆冷风险高(6/25德国/美国翻车教训)",
  "matches": [
    {
      "id": "WC2026_M060", "kickoff_cst": "2026-06-26 15:00 ET", "group": "I", "round": 3, "tag": "CLOSE_MATCH",
      "home": { "code": "NOR", "name_zh": "挪威", "flag": "🇳🇴", "fifa_rank": 31 },
      "away": { "code": "FRA", "name_zh": "法国", "flag": "🇫🇷", "fifa_rank": 2 },
      "venue": "Boston Stadium, 波士顿", "altitude_m": 10, "temp_c": 24, "humidity_pct": 60, "referee": "未公布",
      ...
      "expected_goals": { "home": 1.20, "away": 1.65 }, "expected_score": "1 : 2",
      "over_2_5": 53.0, "btts": 55.0, "clean_sheet_home": 24.0, "confidence": 55,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 0.40, "items": [
          { "label": "Haaland", "value": "+", "note": "Haaland火热(4-1伊拉克),挪威2连胜势头正盛" },
          { "label": "both_through", "value": "+", "note": "挪威已出线无压力,可放开踢争头名" },
          { "label": "Odegaard", "value": "+", "note": "Ødegaard组织+Haaland终结,进攻有质量" } ] },
        "home_risk": { "score": -0.95, "items": [
          { "label": "FRA_quality", "value": "-", "note": "FIFA 2 vs 31,法国Mbappé+Tchouaméni深度全面碾压" },
          { "label": "FRA_form", "value": "-", "note": "法国2连胜(3-1塞/3-0伊)零封能力强,防Haaland有人" },
          { "label": "rotation_risk", "value": "±", "note": "若挪威大轮换护淘汰赛则强度降" } ] },
        "away_upset_path": { "score": 0.55, "items": [
          { "label": "market_fav", "value": "本就favorite", "note": "法国盘口隐含~45-50%,模型贴市场" },
          { "label": "Mbappe", "value": "+", "note": "Mbappé速度打挪威压上的身后,反击致命" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "rotation_both", "value": "±", "note": "★双方轮换幅度=最大变量;都出线易踢成温和平局" },
          { "label": "head_to_head_GD", "value": "±", "note": "争头名靠净胜球,可能影响进攻欲望" },
          { "label": "first_goal", "value": "±", "note": "谁先进球决定另一方是否压上" } ] }
      },
      "players": {
        "home": [
          { "name": "Erling Haaland", "pos": "ST", "status": "HOT", "note": "本届火热,4-1伊拉克进球" },
          { "name": "Martin Ødegaard", "pos": "AM", "status": "KEY", "note": "阿森纳,组织核心" },
          { "name": "Alexander Sørloth", "pos": "ST", "status": "OK", "note": "副锋" },
          { "name": "挪威后防", "pos": "DF", "status": "QUEST", "note": "防Mbappé速度是难题" } ],
        "away": [
      ...
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank NOR#31 FRA#2;两队都已出线争头名" },
        { "time": "—", "level": "WARN", "msg": "都无压力可能轮换→近三选一,但法国质量占优;Haaland vs Mbappé钩子" },
        { "time": "—", "level": "OK", "msg": "poisson output: 28.0 / 28.0 / 44.0" } ],
      "result": { "status": "FT", "home_goals": 1, "away_goals": 4, "scoreline": "1 - 4",
        "scorers": [ { "min": "—", "team": "FRA", "player": "法国", "type": "4-1大胜,Mbappé领衔" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "法国4-1血洗挪威。模型押法国(44%三选一)→方向对,但判温和平局(1:2),实际法国4球血洗", "source": "多源核实" },
      "review": { "verdict": "HIT",
        "headline": "★方向命中:法国44%→4-1。但'都出线可能轮换→温和平局'判断错,法国全力4球血洗",
        "hits": [ "★胜负方向对：法国44%(三选一最高)→赢 ✓（真盲测）", "Mbappé/法国质量碾压挪威兑现" ],
        "misses": [ "★比分严重低估:预测法国1.65球→实际4球", "'两队都出线可能轮换打平'判断错,法国根本没留力" ],
        "model_lesson": "又一个强队进球低估+'已出线轮换'误判。法国争头名全力打,4-1。末轮豪强进球λ要更敢给" }
    },
    {
      "id": "WC2026_M061", "kickoff_cst": "2026-06-26 15:00 ET", "group": "I", "round": 3, "tag": null,
      "home": { "code": "SEN", "name_zh": "塞内加尔", "flag": "🇸🇳", "fifa_rank": 15 },
      "away": { "code": "IRQ", "name_zh": "伊拉克", "flag": "🇮🇶", "fifa_rank": 58 },
      "venue": "Toronto Stadium, 多伦多", "altitude_m": 76, "temp_c": 23, "humidity_pct": 58, "referee": "未公布",
      "headline": "塞内加尔58%：两队都0分已出局的荣誉战。塞内加尔纸面实力(FIFA15)远超伊拉克,但两连败士气低迷",
      "probabilities": { "home_win": 58.0, "draw": 23.0, "away_win": 19.0 },
      "expected_goals": { "home": 1.70, "away": 0.85 }, "expected_score": "2 : 0",
      "over_2_5": 48.0, "btts": 44.0, "clean_sheet_home": 42.0, "confidence": 60,
      "monte_carlo_n": 50000, "value_rating": 2, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 1.00, "items": [
          { "label": "rank_gap", "value": "+", "note": "FIFA 15 vs 58,塞内加尔(Mané/Koulibaly级)个人能力强一档" },
          { "label": "pride", "value": "+", "note": "塞内加尔两连败,荣誉战想体面收尾" },
          { "label": "IRQ_weak", "value": "+", "note": "伊拉克两场丢7球(0-4法/1-4挪),防线脆弱" } ] },
        "home_risk": { "score": -0.55, "items": [
          { "label": "SEN_morale", "value": "-", "note": "塞内加尔两连败信心崩,无欲无求易松懈" },
          { "label": "dead_rubber", "value": "-", "note": "双方都出局,可能踢得拖沓低强度" },
          { "label": "IRQ_park_bus", "value": "-", "note": "伊拉克若摆大巴,塞内加尔低迷锋线难破" } ] },
        "away_upset_path": { "score": 0.35, "items": [
          { "label": "both_eliminated", "value": "+", "note": "都出局=变量大,伊拉克放手一搏或偷分" },
          { "label": "SEN_flat", "value": "+", "note": "塞内加尔松懈则伊拉克定位球偷袭" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "motivation", "value": "±", "note": "★两队荣誉战动机=最大未知,易踢成闷局" },
          { "label": "rotation", "value": "±", "note": "塞内加尔可能练新人" },
          { "label": "first_goal", "value": "±", "note": "塞内加尔早进则轻松" } ] }
      },
      "players": {
        "home": [
          { "name": "塞内加尔锋线", "pos": "FW", "status": "QUEST", "note": "两连败,需找回状态" },
          { "name": "Pape Matar Sarr", "pos": "CM", "status": "OK", "note": "热刺,中场" },
          { "name": "Édouard Mendy", "pos": "GK", "status": "OK", "note": "门将" },
          { "name": "Kalidou Koulibaly", "pos": "CB", "status": "OK", "note": "后防核心" } ],
        "away": [
          { "name": "Aymen Hussein", "pos": "ST", "status": "OK", "note": "伊拉克锋线" },
          { "name": "伊拉克防线", "pos": "DF", "status": "QUEST", "note": "两场丢7球" },
          { "name": "Jalal Hassan", "pos": "GK", "status": "OK", "note": "门将" },
          { "name": "伊拉克中场", "pos": "CM", "status": "OK", "note": "拼抢" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank SEN#15 IRQ#58;双方均已出局" },
        { "time": "—", "level": "WARN", "msg": "荣誉战双方无欲→给塞内加尔58%但置信不高,易闷局" },
        { "time": "—", "level": "OK", "msg": "poisson output: 58.0 / 23.0 / 19.0" } ],
      "result": { "status": "FT", "home_goals": 5, "away_goals": 0, "scoreline": "5 - 0",
        "scorers": [ { "min": "4'", "team": "SEN", "player": "Habib Diarra", "type": "开场闪击" }, { "min": "—", "team": "SEN", "player": "Sarr/Pape Gueye×2/Ndiaye", "type": "下半场打崩" } ],
        "red_cards": [ { "team": "IRQ", "player": "Rebin Sulaka", "min": "—" } ],
        "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "塞内加尔5-0血洗伊拉克(10人)。模型押塞(58%)→方向对,但赛前判'易闷局/低比分'惨败,塞4分钟就破门", "source": "ESPN/Sky" },
      "review": { "verdict": "HIT",
        "headline": "★方向命中但满盘皆输:塞58%→5-0。我赛前判'荣誉战易闷局/士气低'彻底打脸",
        "hits": [ "★胜负方向对：塞内加尔58%→赢 ✓（真盲测）" ],
        "misses": [ "★比分灾难性低估:预测塞1.70球→实际5球(伊拉克红牌后放开,但法国/比利时无红牌也打崩=系统性)", "★赛前'易闷局/无欲/磨不开'判断完全错,塞4分钟进球" ],
        "model_lesson": "【三重打脸·必须认】①方向对但比分离谱低估 ②赛前'闷局'判断错 ③我还给发哥下注分析说'易闷局、伊拉克+1.5最好',结果5-0,我贬低的'塞独赢1.22'才中。无欲战+我的'闷局'直觉=双重失败,红牌是变量但方向就错" }
    },
    {
      "id": "WC2026_M062", "kickoff_cst": "2026-06-26 20:00 ET", "group": "H", "round": 3, "tag": "CLOSE_MATCH",
      "home": { "code": "URU", "name_zh": "乌拉圭", "flag": "🇺🇾", "fifa_rank": 11 },
      "away": { "code": "ESP", "name_zh": "西班牙", "flag": "🇪🇸", "fifa_rank": 3 },
      "venue": "Estadio Akron, 瓜达拉哈拉", "altitude_m": 1566, "temp_c": 22, "humidity_pct": 52, "referee": "未公布",
      "headline": "西班牙40%：夺冠热门(4-0沙特)争头名,平即够。乌拉圭2分必须搏分,Núñez/Valverde会拼命→生死战压低西班牙",
      "probabilities": { "home_win": 29.0, "draw": 31.0, "away_win": 40.0 },
      "expected_goals": { "home": 1.05, "away": 1.40 }, "expected_score": "1 : 1",
      "over_2_5": 44.0, "btts": 48.0, "clean_sheet_home": 28.0, "confidence": 54,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "ELEVATED",
      "modules": {
        "home_win_reasons": { "score": 0.45, "items": [
          { "label": "must_win", "value": "+", "note": "乌拉圭2分,赢才稳出线,Bielsa会全力压上" },
          { "label": "Nunez_Valverde", "value": "+", "note": "Núñez冲击+Valverde中场强度,硬度足" },
          { "label": "physicality", "value": "+", "note": "乌拉圭身体+经验,能搅乱西班牙传控" } ] },
        "home_risk": { "score": -0.90, "items": [
          { "label": "ESP_quality", "value": "-", "note": "FIFA 3,西班牙Yamal/Pedri传控+4-0沙特火力验证" },
          { "label": "ESP_form", "value": "-", "note": "西班牙小组最强,控球碾压可耗死乌拉圭" },
          { "label": "altitude", "value": "-", "note": "瓜达拉哈拉1566m海拔,体能消耗大" } ] },
        "away_upset_path": { "score": 0.55, "items": [
          { "label": "market_fav", "value": "本就favorite", "note": "西班牙盘口favorite,模型贴市场" },
          { "label": "draw_enough", "value": "±", "note": "西班牙平局即头名,可能控场不冒进→压低己方λ" },
          { "label": "Yamal", "value": "+", "note": "Yamal/Williams边路爆点" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "ESP_motivation", "value": "±", "note": "★西班牙平即头名,会否全力=关键;若控场则比分低" },
          { "label": "URU_desperation", "value": "+", "note": "乌拉圭必须赢→后段压上留反击空间" },
          { "label": "cards", "value": "-", "note": "乌拉圭身体战,红黄牌风险高" } ] }
      },
      "players": {
        "home": [
          { "name": "Darwin Núñez", "pos": "ST", "status": "KEY", "note": "冲击点,必须进球" },
          { "name": "Federico Valverde", "pos": "CM", "status": "KEY", "note": "中场引擎" },
          { "name": "Ronald Araújo", "pos": "CB", "status": "OK", "note": "后防" },
          { "name": "Facundo Pellistri", "pos": "WG", "status": "OK", "note": "边路" } ],
        "away": [
          ...
          { "name": "西班牙轮换", "pos": "—", "status": "QUEST", "note": "已基本出线,或部分轮换" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank URU#11 ESP#3;西班牙平即头名" },
        { "time": "—", "level": "WARN", "msg": "乌拉圭必须赢会拼命+西班牙平即够→平局31%当风险标尺,不硬猜" },
        { "time": "—", "level": "OK", "msg": "poisson output: 29.0 / 31.0 / 40.0" } ],
      "result": { "status": "FT", "home_goals": 0, "away_goals": 1, "scoreline": "0 - 1",
        "scorers": [ { "min": "—", "team": "ESP", "player": "西班牙", "type": "1-0小胜,锁头名" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "西班牙1-0小胜乌拉圭,锁A组... K组头名。模型押西班牙(40%三选一)+判低比分→双双命中", "source": "多源核实" },
      "review": { "verdict": "HIT",
        "headline": "★难得比分也判对:西班牙40%→1-0。赛前'平即头名可能控场+乌拉圭硬→低比分'精准",
        "hits": [ "★胜负方向对：西班牙40%(三选一最高)→赢 ✓（真盲测）", "★低比分判断对(预警生死战谨慎+西班牙控场)→1-0,和强队井喷场相反", "乌拉圭进攻被掐(0进球)" ],
        "misses": [ "略,几乎完美" ],
        "model_lesson": "今日唯一'方向+比分都对'的一场。'西班牙平即头名会控场不冒进'的判断把比分压住了,证明双λ思路在'有理由保守的强队'身上work" }
    },
    {
      "id": "WC2026_M063", "kickoff_cst": "2026-06-26 20:00 ET", "group": "H", "round": 3, "tag": null,
      "home": { "code": "CPV", "name_zh": "佛得角", "flag": "🇨🇻", "fifa_rank": 70 },
      "away": { "code": "KSA", "name_zh": "沙特", "flag": "🇸🇦", "fifa_rank": 56 },
      "venue": "NRG Stadium, 休斯顿", "altitude_m": 15, "temp_c": 29, "humidity_pct": 68, "referee": "未公布",
      "headline": "佛得角42%：2分搏出线(逼平西班牙的黑马),沙特1分已基本出局(0-4惨败西班牙)。低排名互掐,比分偏低",
      "probabilities": { "home_win": 42.0, "draw": 29.0, "away_win": 29.0 },
      "expected_goals": { "home": 1.15, "away": 0.95 }, "expected_score": "1 : 0",
      "over_2_5": 38.0, "btts": 42.0, "clean_sheet_home": 40.0, "confidence": 53,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 0.50, "items": [
          { "label": "must_win", "value": "+", "note": "佛得角赢可能搏出线(黑马,逼平过西班牙),全力踢" },
          { "label": "morale", "value": "+", "note": "0-0西班牙+1-1乌拉圭的硬度,防守组织好" },
          { "label": "KSA_low", "value": "+", "note": "沙特0-4惨败西班牙信心受挫" } ] },
        "home_risk": { "score": -0.60, "items": [
          { "label": "CPV_attack", "value": "-", "note": "佛得角进攻有限,破密集防守乏力" },
          { "label": "KSA_counter", "value": "-", "note": "沙特反击+定位球仍有威胁" },
          { "label": "low_scoring", "value": "-", "note": "两队都偏防守,易闷平" } ] },
        "away_upset_path": { "score": 0.30, "items": [
          { "label": "KSA_pride", "value": "+", "note": "沙特荣誉战想雪耻" },
          { "label": "set_piece", "value": "+", "note": "沙特定位球偷分" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "group_math", "value": "±", "note": "★佛得角出线还要看乌拉圭-西班牙结果,影响其冒进度" },
          { "label": "first_goal", "value": "±", "note": "谁先进谁掌握主动" },
          { "label": "heat", "value": "-", "note": "休斯顿高温高湿,降节奏" } ] }
      },
      "players": {
        "home": [
          { "name": "Ryan Mendes", "pos": "FW", "status": "OK", "note": "佛得角核心" },
          { "name": "佛得角后防", "pos": "DF", "status": "OK", "note": "逼平西班牙的组织" },
          { "name": "Vozinha", "pos": "GK", "status": "OK", "note": "门将" },
          { "name": "佛得角中场", "pos": "CM", "status": "OK", "note": "拼抢" } ],
        "away": [
          { "name": "Salem Al-Dawsari", "pos": "WG", "status": "KEY", "note": "沙特爆点" },
          { "name": "Firas Al-Buraikan", "pos": "ST", "status": "OK", "note": "锋线" },
          { "name": "沙特防线", "pos": "DF", "status": "QUEST", "note": "0-4失球多" },
          { "name": "沙特门将", "pos": "GK", "status": "OK", "note": "把关" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank CPV#70 KSA#56;佛得角搏出线" },
        { "time": "—", "level": "WARN", "msg": "低排名互掐+佛得角进攻有限→低比分,平局当风险" },
        { "time": "—", "level": "OK", "msg": "poisson output: 42.0 / 29.0 / 29.0" } ],
      "result": { "status": "FT", "home_goals": 0, "away_goals": 0, "scoreline": "0 - 0",
        "scorers": [ { "min": "—", "team": "—", "player": "无进球", "type": "0-0闷平" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "佛得角0-0沙特。模型押佛得角(42%)方向没中,但赛前已标'低排名互掐+佛得角进攻有限→低比分,平局当风险'→0-0正中", "source": "多源核实" },
      "review": { "verdict": "MISS",
        "headline": "✗方向没中但风险预警准:押佛得角(42%)→0-0。赛前'低比分+平局风险'全应验",
        "hits": [ "★低比分判断精准(预警'佛得角进攻有限+两队偏防守')→0-0", "平局当风险标尺对" ],
        "misses": [ "方向错:押佛得角42%→0-0平(没押平,但已预警)", "又一个平局" ],
        "model_lesson": "平局盲区,但'弱队互掐易闷平'的低比分预警到位。这类场维持'分胜负看赢家+平局当风险',不硬押" }
    },
    {
      "id": "WC2026_M064", "kickoff_cst": "2026-06-26 23:00 ET", "group": "G", "round": 3, "tag": null,
      "home": { "code": "NZL", "name_zh": "新西兰", "flag": "🇳🇿", "fifa_rank": 83 },
      "away": { "code": "BEL", "name_zh": "比利时", "flag": "🇧🇪", "fifa_rank": 8 },
      "venue": "BC Place, 温哥华", "altitude_m": 0, "temp_c": 21, "humidity_pct": 55, "referee": "未公布",
      "headline": "比利时53%：必须赢才出线(两平挣扎中),De Bruyne需带队。新西兰1分顽强(2-2伊朗)但实力差一档",
      "probabilities": { "home_win": 20.0, "draw": 27.0, "away_win": 53.0 },
      "expected_goals": { "home": 0.80, "away": 1.65 }, "expected_score": "0 : 2",
      "over_2_5": 47.0, "btts": 40.0, "clean_sheet_home": 18.0, "confidence": 58,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": -1.20, "items": [
          { "label": "NZL_fight", "value": "+", "note": "新西兰顽强(2-2逼平伊朗),身体+定位球能搅局" },
          { "label": "BEL_struggle", "value": "+", "note": "比利时两平(1-1埃及/0-0伊朗)进攻哑火,信心不足" },
          { "label": "nothing_to_lose", "value": "+", "note": "新西兰无包袱可冲" } ] },
        "home_risk": { "score": -1.55, "items": [
          { "label": "BEL_quality", "value": "-", "note": "FIFA 8,De Bruyne/Doku个人能力碾压,必须赢会爆发" },
          { "label": "BEL_must_win", "value": "-", "note": "比利时必须赢出线→全力进攻不轮换" },
          { "label": "NZL_attack", "value": "-", "note": "新西兰进攻有限,难持续威胁" } ] },
        "away_upset_path": { "score": 1.30, "items": [
          { "label": "must_win_push", "value": "+", "note": "比利时必须赢→全力压上,质量终会破门" },
          { "label": "De_Bruyne", "value": "+", "note": "De Bruyne组织+定位球解锁密集防守" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "BEL_early_goal", "value": "±", "note": "★比利时早进球则放开,僵持久则焦虑(参其两平)" },
          { "label": "NZL_block", "value": "±", "note": "新西兰摆大巴能撑多久" },
          { "label": "set_piece", "value": "±", "note": "新西兰定位球是唯一爆冷路径" } ] }
      },
      "players": {
        "home": [
          { "name": "Chris Wood", "pos": "ST", "status": "KEY", "note": "支点前锋" },
          { "name": "新西兰后防", "pos": "DF", "status": "OK", "note": "顽强,逼平伊朗" },
          { "name": "新西兰门将", "pos": "GK", "status": "OK", "note": "扑救指望" },
          { "name": "新西兰中场", "pos": "CM", "status": "OK", "note": "拼抢" } ],
        "away": [
          { "name": "Kevin De Bruyne", "pos": "AM", "status": "KEY", "note": "组织核心,解锁关键" },
          { "name": "Jérémy Doku", "pos": "WG", "status": "OK", "note": "边路突破" },
          { "name": "Romelu Lukaku", "pos": "ST", "status": "QUEST", "note": "终结点,需找状态" },
          { "name": "比利时中场", "pos": "CM", "status": "OK", "note": "控制" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank NZL#83 BEL#8;比利时必须赢" },
        { "time": "—", "level": "WARN", "msg": "比利时必须赢→全力(非无欲轮换),给53%;但其两平哑火是隐患" },
        { "time": "—", "level": "OK", "msg": "poisson output: 20.0 / 27.0 / 53.0" } ],
      "result": { "status": "FT", "home_goals": 1, "away_goals": 5, "scoreline": "1 - 5",
        "scorers": [ { "min": "—", "team": "BEL", "player": "Trossard 双响 等", "type": "5-1大胜,末段连入" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "比利时5-1血洗新西兰。模型押比利时(53%)→方向对,但'两平挣扎'的比利时这场彻底放开,5球", "source": "FIFA/ESPN" },
      "review": { "verdict": "HIT",
        "headline": "★方向命中:比利时53%→5-1。'必须赢全力'判断对,但比分又严重低估(预测1.65球→5球)",
        "hits": [ "★胜负方向对：比利时53%→赢 ✓（真盲测）", "★'必须赢→全力(非无欲轮换)'判断对,比利时放开打崩新西兰", "新西兰挡不住质量差" ],
        "misses": [ "★比分大低估:预测比利时1.65球→实际5球", "两平哑火的比利时一旦放开就井喷,模型没料到" ],
        "model_lesson": "又一个强队进球低估(今日法国4/塞5/比利时5,预测全1.6-1.7)。对'必须赢且质量碾压'的豪强,进球λ要大幅上调" }
    },
    {
      "id": "WC2026_M065", "kickoff_cst": "2026-06-26 23:00 ET", "group": "G", "round": 3, "tag": "CLOSE_MATCH",
      "home": { "code": "EGY", "name_zh": "埃及", "flag": "🇪🇬", "fifa_rank": 33 },
      "away": { "code": "IRN", "name_zh": "伊朗", "flag": "🇮🇷", "fifa_rank": 18 },
      "venue": "Lumen Field, 西雅图", "altitude_m": 5, "temp_c": 23, "humidity_pct": 60, "referee": "未公布",
      "headline": "埃及40%微favored：4分领头(3-1新西兰),Salah火热。伊朗2分防守硬(0-0比利时)需搏分→低比分胶着",
      "probabilities": { "home_win": 40.0, "draw": 31.0, "away_win": 29.0 },
      "expected_goals": { "home": 1.25, "away": 0.95 }, "expected_score": "1 : 1",
      "over_2_5": 40.0, "btts": 45.0, "clean_sheet_home": 32.0, "confidence": 54,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "ELEVATED",
      "modules": {
        "home_win_reasons": { "score": 0.45, "items": [
          { "label": "Salah", "value": "+", "note": "Salah火热+埃及3-1新西兰进攻打开,领头有动机争头名" },
          { "label": "EGY_lead", "value": "+", "note": "埃及4分占先,赢/平多数情况出线,心态主动" },
          { "label": "home_morale", "value": "+", "note": "状态回升,锋线有产出" } ] },
        "home_risk": { "score": -0.75, "items": [
          { "label": "IRN_defense", "value": "-", "note": "★伊朗防守扎实(0-0逼平比利时),低比分能限制埃及" },
          { "label": "IRN_must", "value": "-", "note": "伊朗需搏分出线,会全力+反击Taremi" },
          { "label": "IRN_rank", "value": "-", "note": "FIFA 18高于埃及33,整体不弱" } ] },
        "away_upset_path": { "score": 0.55, "items": [
          { "label": "Taremi_counter", "value": "+", "note": "Taremi/Azmoun反击+定位球抓机会" },
          { "label": "low_block", "value": "+", "note": "伊朗低位防守+反击,0-1/1-0最可能" },
          { "label": "must_win_edge", "value": "+", "note": "伊朗求胜欲强于已占先的埃及" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "low_scoring", "value": "-", "note": "★伊朗防守+生死战谨慎→低比分,平局风险高" },
          { "label": "group_math", "value": "±", "note": "另一场新西兰-比利时结果影响两队冒进度" },
          { "label": "Salah_marking", "value": "±", "note": "伊朗如何盯防Salah决定埃及进攻效率" } ] }
      },
      "players": {
        "home": [
          { "name": "Mohamed Salah", "pos": "RW", "status": "HOT", "note": "队长,进攻核心" },
          { "name": "Omar Marmoush", "pos": "FW", "status": "OK", "note": "搭档锋线" },
          { "name": "埃及后防", "pos": "DF", "status": "OK", "note": "组织" },
          { "name": "埃及门将", "pos": "GK", "status": "OK", "note": "把关" } ],
        "away": [
          { "name": "Mehdi Taremi", "pos": "ST", "status": "KEY", "note": "反击爆点" },
          { "name": "Sardar Azmoun", "pos": "FW", "status": "OK", "note": "终结" },
          { "name": "伊朗后防", "pos": "DF", "status": "KEY", "note": "逼平比利时的铁防" },
          { "name": "Alireza Beiranvand", "pos": "GK", "status": "OK", "note": "门将" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank EGY#33 IRN#18;埃及领头伊朗搏分" },
        { "time": "—", "level": "WARN", "msg": "伊朗铁防+生死战谨慎→低比分,平局31%当风险标尺" },
        { "time": "—", "level": "OK", "msg": "poisson output: 40.0 / 31.0 / 29.0" } ],
      "result": { "status": "FT", "home_goals": 1, "away_goals": 1, "scoreline": "1 - 1",
        "scorers": [ { "min": "5'", "team": "EGY", "player": "Mahmoud Saber" }, { "min": "14'", "team": "IRN", "player": "Ramin Rezaeian" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "埃及1-1伊朗(伊朗补时绝杀被VAR越位取消)。模型押埃及(40%)方向没中,但赛前标'伊朗铁防+生死战谨慎→低比分平局风险'→1-1正中,埃及险些输", "source": "FIFA/ESPN" },
      "review": { "verdict": "MISS",
        "headline": "✗方向没中但风险预警准:押埃及(40%)→1-1。赛前'伊朗铁防+平局风险'应验,埃及还差点被VAR绝杀",
        "hits": [ "★平局风险+低比分判断对(预警'伊朗铁防+生死战谨慎')→1-1", "Taremi/伊朗反击威胁判对(伊朗险绝杀,VAR越位救了埃及)" ],
        "misses": [ "方向错:押埃及40%→1-1平(没押平,但已预警)", "又一个平局" ],
...
// ══════════════════ matches-0629.js ══════════════════
// 世界杯预测 - 2026-06-29（淘汰赛 Round of 32 · 豪门批量，真预测，带盘口）
// ⚠️淘汰赛:90分钟平→加时/点球,下列为90分钟胜平负,"平"=进加时;点球随机·模型不算
// 日期/时间由 The Odds API 的 commence_time(UTC)换算ET确定,绝对准
// 队代码:BRA/JPN GER/PAR NED/MAR
window.WCP_DAYS = window.WCP_DAYS || {};
window.WCP_DAYS["2026-06-29"] = {
  "date": "2026-06-29", "tournament": "FIFA World Cup 2026 · 淘汰赛 Round of 32",
  "model_version": "POISSON v1.4 + 淘汰赛(加时/点球)修正", "model_accuracy_7d": null,
  "data_note": "★真预测,ODDS tab有48家盘口;淘汰赛90分钟胜平负,'平'=进加时;点球随机不预测",
  "matches": [
    {
      "id": "WC2026_R32_02", "kickoff_cst": "2026-06-29 13:00 ET", "group": "R32", "round": 4, "tag": "KNOCKOUT",
      "home": { "code": "BRA", "name_zh": "巴西", "flag": "🇧🇷", "fifa_rank": 6 },
      "away": { "code": "JPN", "name_zh": "日本", "flag": "🇯🇵", "fifa_rank": 18 },
      "venue": "NRG Stadium, 休斯顿", "altitude_m": 15, "temp_c": 29, "humidity_pct": 68, "referee": "未公布",
      "headline": "巴西52%(90分钟)：Vini领衔实力占优,但日本技术流+淘汰赛韧性(曾掀翻德西)。庄家给巴西56%,我略低——日本爆冷基因不容小觑",
      "probabilities": { "home_win": 52.0, "draw": 26.0, "away_win": 22.0 },
      "expected_goals": { "home": 1.55, "away": 1.05 }, "expected_score": "1 : 1",
      "over_2_5": 50.0, "btts": 52.0, "clean_sheet_home": 30.0, "confidence": 56,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "ELEVATED",
      "modules": {
        "home_win_reasons": { "score": 0.75, "items": [
          { "label": "Vini_quality", "value": "+", "note": "Vinícius/Cunha个人能力+巴西头名出线,纸面更强" },
          { "label": "depth", "value": "+", "note": "巴西替补深度厚,淘汰赛轮换余地大" },
          { "label": "JPN_defense", "value": "+", "note": "日本后防面对巴西速度有压力" } ] },
        "home_risk": { "score": -0.85, "items": [
          { "label": "JPN_press", "value": "-", "note": "★日本高位逼抢+技术流,曾2-1掀翻德国/西班牙,淘汰赛韧性强" },
          { "label": "BRA_inconsistent", "value": "-", "note": "巴西小组赛起伏(被苏格兰逼过),状态不稳定" },
          { "label": "Mitoma_Kubo", "value": "-", "note": "三笘薫/久保建英边路能打巴西压上的身后" } ] },
        "away_upset_path": { "score": 0.70, "items": [
          { "label": "vs_market", "value": "★分歧", "note": "庄家巴西56.4%,我给52%——更看好日本的淘汰赛爆冷空间" },
          { "label": "set_piece_counter", "value": "+", "note": "日本定位球+快速反击" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "BRA_rotation", "value": "±", "note": "巴西是否轮换护核心" },
          { "label": "first_goal", "value": "±", "note": "日本先进则巴西需压上,反击空间给日本" },
          { "label": "extra_time", "value": "±", "note": "胶着易进加时,日本体能+纪律是X factor" } ] }
      },
      "players": {
        "home": [
          { "name": "Vinícius Júnior", "pos": "LW", "status": "HOT", "note": "进攻箭头" },
          { "name": "Matheus Cunha", "pos": "ST", "status": "OK", "note": "终结点" },
          { "name": "Bruno Guimarães", "pos": "CM", "status": "OK", "note": "中场" },
          { "name": "Alisson", "pos": "GK", "status": "OK", "note": "门将" } ],
        "away": [
          { "name": "Kaoru Mitoma", "pos": "LW", "status": "KEY", "note": "布莱顿,边路爆点" },
          { "name": "Takefusa Kubo", "pos": "RW", "status": "OK", "note": "皇家社会" },
          { "name": "Wataru Endo", "pos": "CM", "status": "OK", "note": "中场屏障" },
          { "name": "Daizen Maeda", "pos": "ST", "status": "OK", "note": "冲击+逼抢" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有48家盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank BRA#6 JPN#18;R32淘汰赛" },
        { "time": "—", "level": "WARN", "msg": "★模型52% vs 庄家56.4%:我更看好日本爆冷;淘汰赛胶着易进加时" },
        { "time": "—", "level": "OK", "msg": "poisson output(90min): 52.0 / 26.0 / 22.0" } ],
      "result": { "status": "FT", "home_goals": 2, "away_goals": 1, "scoreline": "2 - 1",
        "scorers": [ { "min": "~28'", "team": "JPN", "player": "Kaishu Sano", "type": "日本先进" }, { "min": "—", "team": "BRA", "player": "Casemiro", "type": "头球扳平" }, { "min": "96'", "team": "BRA", "player": "Gabriel Martinelli", "type": "补时绝杀" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "巴西2-1日本,Martinelli 96分钟绝杀,常规时间晋级。模型押巴西(52%)→方向对,日本先进球顽强(我赛前给的'爆冷空间'判对一半)", "source": "ESPN/FIFA" },
      "review": { "verdict": "HIT",
        "headline": "★晋级方向对:巴西52%→2-1绝杀晋级。日本顽强先进球(印证'爆冷空间'),但终被巴西实力带走",
        "hits": [ "★晋级方向对：巴西52%→赢 ✓（真盲测）", "★'日本爆冷空间'判对一半:日本Sano先进球1-1顽强", "Martinelli补时绝杀,巴西深度兑现" ],
        "misses": [ "巴西90分钟拿下(没进加时),我给日本22%略高;但方向对" ],
        "model_lesson": "顺庄家+押对的一场。日本确实顽强(先进球)但实力差被96分钟绝杀,巴西没让比赛拖进加时" }
    },
    {
      "id": "WC2026_R32_03", "kickoff_cst": "2026-06-29 16:30 ET", "group": "R32", "round": 4, "tag": "KNOCKOUT",
      "home": { "code": "GER", "name_zh": "德国", "flag": "🇩🇪", "fifa_rank": 9 },
      "away": { "code": "PAR", "name_zh": "巴拉圭", "flag": "🇵🇾", "fifa_rank": 56 },
      "venue": "Gillette Stadium, 福克斯堡", "altitude_m": 28, "temp_c": 25, "humidity_pct": 60, "referee": "未公布",
      "headline": "德国62%(90分钟)：火力强(小组赛井喷),但被厄瓜多尔爆冷过+防守不稳。巴拉圭铁防(0-0澳出线)。庄家给德国70%,我略低留巴拉圭爆冷余地",
      "probabilities": { "home_win": 62.0, "draw": 23.0, "away_win": 15.0 },
      "expected_goals": { "home": 1.75, "away": 0.80 }, "expected_score": "2 : 0",
      "over_2_5": 52.0, "btts": 42.0, "clean_sheet_home": 42.0, "confidence": 60,
      "monte_carlo_n": 50000, "value_rating": 2, "edge_pct": null, "red_card_risk": "LOW",
      "modules": {
        "home_win_reasons": { "score": 1.10, "items": [
          { "label": "GER_firepower", "value": "+", "note": "德国小组赛火力井喷(进球多),Wirtz/Musiala级中前场" },
          { "label": "rank_gap", "value": "+", "note": "FIFA 9 vs 56,整体实力高一档" },
          { "label": "PAR_no_attack", "value": "+", "note": "巴拉圭进攻乏力(0-0澳大利亚靠防守出线)" } ] },
        "home_risk": { "score": -0.80, "items": [
          { "label": "GER_defense", "value": "-", "note": "★德国防守不稳,被厄瓜多尔2-1爆冷淘汰过(小组赛),后防有漏洞" },
          { "label": "PAR_ironwall", "value": "-", "note": "巴拉圭铁防+身体硬,擅长0-0/1-0磨" },
          { "label": "knockout_pressure", "value": "-", "note": "德国大赛淘汰赛近年常翻车" } ] },
        "away_upset_path": { "score": 0.55, "items": [
          { "label": "vs_market", "value": "★分歧", "note": "庄家德国69.9%,我给62%——德国防守不稳+巴拉圭铁防,留更多爆冷/加时空间" },
          { "label": "park_bus_pen", "value": "+", "note": "巴拉圭摆大巴拖进点球是唯一路径" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "GER_early", "value": "±", "note": "德国早进球则放开,僵持久则焦虑(参淘汰赛历史)" },
          { "label": "PAR_discipline", "value": "±", "note": "巴拉圭能否90分钟守住" },
          { "label": "penalties", "value": "±", "note": "若拖进点球,德国近年点球心理是隐患" } ] }
      },
      "players": {
        "home": [
          { "name": "Florian Wirtz", "pos": "AM", "status": "KEY", "note": "创造核心" },
          { "name": "Jamal Musiala", "pos": "AM", "status": "HOT", "note": "突破爆点" },
          { "name": "Kai Havertz", "pos": "ST", "status": "OK", "note": "终结" },
          { "name": "德国后防", "pos": "DF", "status": "QUEST", "note": "被厄瓜多尔爆过,不稳" } ],
        "away": [
          { "name": "Antonio Sanabria", "pos": "ST", "status": "OK", "note": "支点" },
          { "name": "Diego Gómez", "pos": "CM", "status": "OK", "note": "中场" },
          { "name": "Gustavo Velázquez", "pos": "CB", "status": "KEY", "note": "铁防核心" },
          { "name": "巴拉圭门将", "pos": "GK", "status": "KEY", "note": "摆大巴指望" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有48家盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank GER#9 PAR#56;R32淘汰赛" },
        { "time": "—", "level": "WARN", "msg": "★模型62% vs 庄家69.9%:德国防守不稳+巴拉圭铁防,我留更多爆冷余地" },
        { "time": "—", "level": "OK", "msg": "poisson output(90min): 62.0 / 23.0 / 15.0" } ],
      "result": { "status": "点球(1-1 / 120分钟)", "home_goals": 1, "away_goals": 1, "scoreline": "1 - 1 (点球 3-4)",
        "scorers": [ { "min": "—", "team": "—", "player": "1-1战平120分钟", "type": "巴拉圭点球4-3淘汰德国" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "★巴拉圭点球(4-3)淘汰德国,世界杯历史级冷门!1-1战平120分钟→点球。德国出局。我90分钟押德国,但赛前预警的'德国防守不稳+巴拉圭铁防+德国点球心理隐患'全中", "source": "Al Jazeera/CBS/France24" },
      "review": { "verdict": "MISS",
        "headline": "✗90分钟押德国但点球出局，然而★赛前逆庄家预警全中:巴拉圭真爆冷淘汰德国",
        "hits": [ "★'进加时'命中:1-1战平120分钟", "★逆庄家:我给巴拉圭15%>庄家10.9%,巴拉圭真爆冷晋级", "★'德国点球心理隐患'精准命中(点球3-4输)", "★'巴拉圭铁防'判对(1-1磨进点球)" ],
        "misses": [ "主概率押德国62%晋级→实际巴拉圭晋级,90分钟胜平负方向错" ],
    ...
    {
      "id": "WC2026_R32_04", "kickoff_cst": "2026-06-29 21:00 ET", "group": "R32", "round": 4, "tag": "KNOCKOUT",
      "home": { "code": "NED", "name_zh": "荷兰", "flag": "🇳🇱", "fifa_rank": 7 },
      "away": { "code": "MAR", "name_zh": "摩洛哥", "flag": "🇲🇦", "fifa_rank": 12 },
      "venue": "Estadio BBVA, 蒙特雷", "altitude_m": 540, "temp_c": 24, "humidity_pct": 55, "referee": "未公布",
      "headline": "强强对话最接近:荷兰41%/平30%/摩洛哥29%。荷兰火力(5-1瑞典)vs摩洛哥(非洲杯冠军+2022四强,有掀翻西葡前科)。庄家荷兰44.5%,基本五五开,最易进加时",
      "probabilities": { "home_win": 41.0, "draw": 30.0, "away_win": 29.0 },
      "expected_goals": { "home": 1.35, "away": 1.10 }, "expected_score": "1 : 1",
      "over_2_5": 48.0, "btts": 54.0, "clean_sheet_home": 28.0, "confidence": 54,
      "monte_carlo_n": 50000, "value_rating": 3, "edge_pct": null, "red_card_risk": "ELEVATED",
      "modules": {
        "home_win_reasons": { "score": 0.45, "items": [
          { "label": "NED_firepower", "value": "+", "note": "荷兰火力验证(5-1瑞典),Gakpo/Depay连线" },
          { "label": "rank_edge", "value": "+", "note": "FIFA 7 vs 12,纸面略占优" },
          { "label": "experience", "value": "+", "note": "荷兰大赛经验+阵容深度" } ] },
        "home_risk": { "score": -0.85, "items": [
          { "label": "MAR_quality", "value": "-", "note": "★摩洛哥非洲杯冠军+2022世界杯四强,Hakimi/Brahim/En-Nesyri质量足" },
          { "label": "MAR_record", "value": "-", "note": "摩洛哥有掀翻西班牙/葡萄牙的前科,淘汰赛硬度强" },
          { "label": "MAR_defense", "value": "-", "note": "摩洛哥防守组织好,荷兰难轻松打穿" } ] },
        "away_upset_path": { "score": 0.85, "items": [
          { "label": "vs_market", "value": "★分歧小", "note": "庄家荷兰44.5%/摩洛哥25.3%,我给摩洛哥29%——这场最接近五五开" },
          { "label": "Hakimi_counter", "value": "+", "note": "Hakimi边路冲击+En-Nesyri终结" },
          { "label": "pen_specialist", "value": "+", "note": "摩洛哥点球大战有2022淘汰西班牙的成功经验" } ] },
        "live_variables": { "score": 0.00, "items": [
          { "label": "tactical", "value": "±", "note": "★两队都强,战术博弈+谁先进球决定走向" },
          { "label": "extra_time_likely", "value": "-", "note": "实力接近+都谨慎→最可能进加时甚至点球" },
          { "label": "En_Nesyri", "value": "±", "note": "摩洛哥锋线状态" } ] }
      },
      "players": {
        "home": [
          { "name": "Cody Gakpo", "pos": "LW", "status": "HOT", "note": "进攻箭头" },
          { "name": "Memphis Depay", "pos": "ST", "status": "OK", "note": "终结+经验" },
          { "name": "Frenkie de Jong", "pos": "CM", "status": "KEY", "note": "中场核心" },
          { "name": "Virgil van Dijk", "pos": "CB", "status": "KEY", "note": "后防领袖" } ],
        "away": [
          { "name": "Achraf Hakimi", "pos": "RB", "status": "KEY", "note": "攻防一体,边路爆点" },
          { "name": "Brahim Díaz", "pos": "AM", "status": "OK", "note": "线间杀手" },
          { "name": "Youssef En-Nesyri", "pos": "ST", "status": "OK", "note": "终结" },
          { "name": "Yassine Bounou", "pos": "GK", "status": "KEY", "note": "门神,点球大战利器" } ]
      },
      "odds": [ { "book": "实时盘口见ODDS tab", "home": null, "draw": null, "away": null, "edge_pct": null } ],
      "live_log": [
        { "time": "—", "level": "OK", "msg": "★真预测,ODDS tab有48家盘口" },
        { "time": "—", "level": "OK", "msg": "FIFA rank NED#7 MAR#12;R32淘汰赛,强强对话" },
        { "time": "—", "level": "WARN", "msg": "★今日最接近五五开:模型41/30/29 vs 庄家44.5/30.2/25.3;最可能进加时点球" },
        { "time": "—", "level": "OK", "msg": "poisson output(90min): 41.0 / 30.0 / 29.0" } ],
      "result": { "status": "点球(1-1 / 120分钟)", "home_goals": 1, "away_goals": 1, "scoreline": "1 - 1 (点球 2-3)",
        "scorers": [ { "min": "—", "team": "NED", "player": "Cody Gakpo", "type": "荷兰下半场进球" }, { "min": "91'", "team": "MAR", "player": "Issa Diop", "type": "91分钟扳平" }, { "min": "点球", "team": "MAR", "player": "Saibari 绝杀", "type": "摩洛哥点球 3-2 晋级" } ],
        "red_cards": [], "stats": { "shots_home": null, "shots_on_target_home": null, "poss_home": null, "poss_away": null },
        "key_moment": "★摩洛哥点球 3-2 淘汰荷兰,荷兰出局!1-1战平120分钟(Gakpo荷兰/Issa Diop 91'扳平)→点球摩洛哥3-2,Saibari罚进绝杀。我赛前三连预警全中:'最接近五五开+最易进点球+摩洛哥点球前科(Bounou门神)'", "source": "NBC/ESPN/FOX" },
      "review": { "verdict": "MISS",
        "headline": "✗90分钟押荷兰但摩洛哥点球晋级，然而★赛前把话说死的三连预警全中",
        "hits": [ "★'最易进加时/点球'精准:1-1战平120分钟→点球", "★逆庄家:我给摩洛哥29%>庄家25.3%,摩洛哥真晋级", "★'摩洛哥点球前科+Bounou门神'判对(点球赢)", "★'最接近五五开'判断对(120分钟1-1)" ],
        "misses": [ "主概率押荷兰41%(最高)→实际摩洛哥晋级,90分钟胜平负方向错" ],
